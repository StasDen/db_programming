...
INSERT INTO client_card(id, `name`, discount_percentage) VALUES
  (1, "Gold customer", 40),
  (2, "Silver customer", 30),
  (3, "Bronze customer", 20);
  
INSERT INTO client(id, first_name, second_name, phone_number, client_card_id) VALUES
  (1, "Mykola", "Yurchenko", "+380 66 122 4935", 2),
...
INSERT INTO discount(id, `name`, percentage) VALUES
  (1, "Winter holidays", 35),
  (2, "Halloween", 25),
  (3, "Easter", 30),
  (4, "First bell", 25),
...
INSERT INTO entertainment_agency(id, `name`, contact_number, address, animator_id, city_id) VALUES
  (1, "Animatorooze", "+380 50 750 5060", "Voli Ave", 5, 1),
...
INSERT INTO consultant(id, first_name, second_name, phone_number, entertainment_agency_id) VALUES
  (1, "Volodymyr", "Sydorenko", "+380 50 331 6602", 3),
...
INSERT INTO `event`(id, `name`, animators_num, visitors_num, `date`, address, duration_in_hours, city_id) VALUES
  (1, "Birthday", 2, 15, "2022-08-11", "Stepana  Bandery St", 3, 1),
...
INSERT INTO party_animator(id, first_name, last_name, phone_number, unique_performance, work_experience_in_years, order_id) VALUES
  (1, "Oleksij", "Movchan", "+380 50 906 2366", NULL, 3, 1),
...
INSERT INTO `order`(id, `name`, cost_in_usd, event_id, discount_id, client_id, entertainment_agency_id) VALUES
  (1, "Birthday", 400, 1, 6, 5, 1),
