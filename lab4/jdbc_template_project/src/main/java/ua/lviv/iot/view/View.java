...
public class View {
    ...
    public View() {
        ...
        menu.put("SE", "  SE - Select all tables");
        ...
        menu.put("056", "   056 - Find Discount by holiday name");
        ...
        menu.put("076", "   076 - Find all Events by city");
        ...
        menu.put("086", "   086 - Find VIP Orders");
        ...
        menu.put("096", "   096 - Find PartyAnimators with unique performances");
        ...
        menuMethods.put("SE", this::selectAllTables);
        ...
        menuMethods.put("056", this::getDiscountByHolidayName);
        ...
        menuMethods.put("076", this::getAllEventsByCityId);
        ...
        menuMethods.put("086", this::getVipOrders);
        ...
        menuMethods.put("096", this::getAllUniquePerformances);
    ...
    private void getDiscountByHolidayName() {
        System.out.println("Input 'name': ");
        String name = input.nextLine();

        Optional<Discount> discount = discountController.getDiscountByHolidayName(name);
        System.out.println(discount.orElse(nullDiscount));
    }
    ...
    public void getAllEventsByCityId() {
        System.out.println("Input city_id: ");
        Integer id = Integer.valueOf(input.nextLine());

        List<Event> events = eventController.getAllEventsByCityId(id);
        for (Event event : events) {
            System.out.println(event);
        }
    }
    ...
    private void getVipOrders() {
        ...
        List<Order> orders = orderController.getVipOrders();
        for (Order order : orders) {
            System.out.println(order);
        }
    }
    ...
    private void getAllUniquePerformances() {
        System.out.println("\nTable: PartyAnimator");
        List<PartyAnimator> partyAnimators = partyAnimatorController.getAllUniquePerformances();
    ...
    public void show() {
        ...
        do {
            ...
            try {
                ...
                System.out.println(e); // No need to call printStackTrace()
            }
        } while (!menuKey.equals("EX"));
    }
}
